...
extension DataManager{
    ...
    public func getAllEventList(withPage page: Int, withInHome inHome: Bool, withEventTypes eventTypes: [Int]? = nil, closure: @escaping (_ codeResult: CodeResult, _ message: String, _ eventList: [EventDB])->()){
        var dic = ["page": "\(page)"]
...
//        }
        ...
        event.doubleAge = jsonDic["doubleAge"] as? Double ?? 0     
